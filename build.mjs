...
const pages = [
  ...
  { tpl: 'index-v3.template.html', out: 'v3.html',
    sections: ['v3-hero', 'v3-clients', 'v3-work', 'v3-artcases', 'v3-how', 'v3-about', 'apply'], post: v3ify },   // v3 has a single compact client block and dedicated responsive diagram/manifesto.
];
